...
class Encodings(object):
	def __init__(self, image):
		...
		self.chordsProgression = np.average(self.image)
		# print self.chordsProgression
		self.drumBeat = np.std(self.image)
		# print self.drumBeat
		self.tempo = 96
		...
		# print centralmat.shape
		self.chorusMeanColor = np.average(np.sum(centralmat, axis=1) / (self.quadBeatNum*4), axis=1)
